...
/*This program has the user enter in the interview as well as the job description. It stores 
all the data in an external txt file to save and will reopen it.
*/
#include<iostream> 
#include<cstring> 
#include<fstream> 
